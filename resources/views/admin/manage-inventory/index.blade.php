    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="#"><i class="bi bi-globe2 small me-2"></i> Manage Inventory</a>
            </li>
...
<a href="{{ route('admin.manage-inventory.create') }}" class="btn btn-primary btn-icon my-2 mb-4">
...
<div class="card" style="background-color: #efefef !important;">
    <div class="card-body">
        <div class="d-md-flex gap-4 align-items-center justify-content-between">
            <div class="fw-bold fs-4">Cars</div>
...
<div class="table-responsive mt-3">
    <table class="table table-custom table-lg mb-0" id="inventory-table">
        <thead>
            <tr>
                <th>ID#</th>
                <th>IMAGE</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Illuminate\Support\Str::words($car->title, 12) }}</td>


                <td class="text-end">
                    <div class="d-flex justify-content-end gap-2 align-items-center">
                        <a href="{{ route('inventory.detail', $car->id) }}" class="btn btn-sm btn-danger"  target="_blank">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="{{ route('admin.manage-inventory.edit', $car->id) }}" >Edit</a></li>
                                <li>
                                    <form action="{{ route('admin.manage-inventory.destroy', $car->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                        @csrf
                                        @method('DELETE')
...
<div class="d-flex justify-content-center mt-3">
    {{ $cars->appends(request()->query())->links('vendor.pagination.bootstrap-5') }}
</div>
...
<script>
    $(document).ready(function() {
        ...
        function updateUrl() {
            ...
            window.location.href = "{{ route('admin.manage-inventory.index') }}?page=1&records=" + recordsPerPage + "&sort=" + sortOption;
        }
